...
//    }
//
//    public static CollectionFragment newInstance(boolean isIvAvatarClickable) {
...
//            mCurrentPage++;
//        }
//        OkGo.post(Api.GET_MY_COOLECTION_MODEL_LIST)
//                .tag(this)
...
//                            if (imageTypeResponse.getData().getTotal() > 0) {
//                                if (isPullRefresh) {//下拉刷新
